...
Rola systemowa & Uprawnienia systemowe \\ \hline
Administrator & x \\ \hline
Prowadzący & y \\ \hline
Uczestnik & z \\ \hline
\end{tabular}
\label{uprawnienia:uzytkownikow}
\caption{Uprawnienia systemowe użytkowników}
