...
Aplikacja testująca kod posiada dodatkowe pole konfiguracyjne określające liczbę uruchamianych aktorów analizujących rozwiązania. Wartość ta powinna uwzględniać konfigurację maszyny, aby uniknąć problemów wydajnościowych.

\begin{alltt}
rabbitmq.solutions.analyzers.number=2
\end{alltt}

W obu przypadkach ustawienia są wczytywane przy starcie aplikacji.
