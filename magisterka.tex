...
AngularJS to wyprodukowane i wspierane przez firmę Google narzędzie. Ideą było stworzenie instrumentu, który pozwoliłby na szybkie budowanie małych~i~dynamicznych aplikacji internetowych. Inżynierom Google'a cel udało się osiągnąć poprzez stworzenie modułu nazywanego ,,kompilatorem HTML'' oraz podwójnego wiązania danych.
