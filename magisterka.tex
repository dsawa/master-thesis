...
%\mint[fontsize=\small]{java}|Double.parseDouble("12.0")|

%wystarczy napisać 

%\mint[fontsize=\small]{scala}|"12.0".toDouble|
...
\newpage 
\textbf{Java}
\inputminted[fontsize=\small]{java}{code/person.java}

\textbf{Scala}
\inputminted[fontsize=\small]{scala}{code/person.scala}
...
Dzięki mechanizmowi dopasowywania wzorca\footnote{ang: Pattern matching} programista Scala jest w stanie stworzyć bardzo elastyczny kod.
