...
\hline
\multirow{4}{*}{Administrator} & \tabitem Dodawanie, edycja, & & \\
								& usuwanie użytkowników & & \\
								& \tabitem Zmiana haseł & & \\  								
								& i uprawnień użytkowników & & \\ 
\hline								 
\multirow{11}{*}{Prowadzący} & \tabitem Tworzenie, edycja grup & \multirow{2}{*}{Założyciel} & \tabitem Zmiana nazwy grupy \\
							& \tabitem Lista powiązanych grup  & 									& \tabitem Usuwanie grupy \\ \cline{3-4}
							& Zmiana haseł i loginów & \multirow{6}{*}{Prowadzący}	 & Przydzielanie uczestników i prowadzących \\
